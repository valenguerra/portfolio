  ...
  return (
    <div className="flex w-full flex-col-reverse items-center  gap-6 md:flex-row">
      ...
      <div className="flex flex-col items-center gap-1 md:flex-1 md:items-start md:gap-4">
        <h1 className="flex text-3xl font-bold text-white md:text-5xl">{texts.superTitle}</h1>
        <h2 className="ml-1 flex text-xl font-light text-white md:ml-2 md:text-3xl">{texts.superSubtitle}</h2>
      </div>
